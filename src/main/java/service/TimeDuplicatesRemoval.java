...
public class TimeDuplicatesRemoval implements DuplicatesRemoval {
    @Override
    public Stream<Pair> removeTimeDuplicate(InputStream inputStream){
        ...
        //split pojedynczych lini (pakietow) na pary czas/voltage i zapis do listy + usuniecie dwukropka
